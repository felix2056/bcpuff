...
<head>
    ...
    <title>BCPUFF Order Confirmation</title>
    <!--[if (mso 16)]>
    <style type="text/css">
                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-header-body"
                                    ...
                                    <tr style="border-collapse:collapse">
                                        <td align="left"
                                            style="Margin:0;padding-top:35px;padding-left:35px;padding-right:35px;padding-bottom:40px;background-image:url(https://iycihw.stripocdn.email/content/guids/92d1ec79-f442-4109-8c2b-b840fc9b0eba/images/44381608293280341.gif);background-repeat:repeat;background-position:left top"
                                            background="https://iycihw.stripocdn.email/content/guids/92d1ec79-f442-4109-8c2b-b840fc9b0eba/images/44381608293280341.gif">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-c" align="center"
                                                                    ...
                                                                    <h3
                                                                        ...
                                                                        Important E-Transfer Information</h3>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-content-body" cellspacing="0" cellpadding="0" align="center"
                                    ...
                                    <tr style="border-collapse:collapse">
                                        <td align="left"
                                            style="Margin:0;padding-bottom:25px;padding-top:35px;padding-left:35px;padding-right:35px;background-image:url(https://iycihw.stripocdn.email/content/guids/92d1ec79-f442-4109-8c2b-b840fc9b0eba/images/44381608293280341.gif);background-repeat:repeat;background-position:left top"
                                            background="https://iycihw.stripocdn.email/content/guids/92d1ec79-f442-4109-8c2b-b840fc9b0eba/images/44381608293280341.gif">
                                            <table width="100%" cellspacing="0" cellpadding="0"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                <tr style="border-collapse:collapse">
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Now that your order has been received, please follow the instructions carefully and send an E-Money transfer (EMT) to:
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <h3
                                                                        style="Margin:0;line-height:22px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:18px;font-style:normal;font-weight:bold;color:#ffffff">
                                                                        Recipent Name: {{ $recipent_name }}</h3>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    style="padding:0;Margin:0;padding-bottom:10px;padding-top:15px">
                                                                    <img src="https://bcpuff.com/images/bar-code.png" alt="bar code" style="Margin:0;width:100%">
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#FFFFFF">
                                                                        Please DO NOT write BC PUFF or Cannabis in any of the EMT text field including receipent name and the message box.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#FFFFFF">
                                                                        Your E-Transfer will be deposited within 2 business days, at which time you will receive an email confirmation.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#FFFFFF">
                                                                        Thank you for choosing us. We appriciate your business.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                    ...
                                    <tr style="border-collapse:collapse">
                                        <td align="left"
                                            ...
                                            <div class="table-responsive" style="display: block;width: 100%;overflow-x: auto;-webkit-overflow-scrolling: touch;">
                                                <table style="width: 100%;color:#fff" class="table table-bordered">
                                                    <thead>
                                                        <tr>
                                                            <th style="border-top: 1px solid #d5dfea;padding: 1rem;vertical-align: middle;">Photo</th>
                                                            <th style="border-top: 1px solid #d5dfea;padding: 1rem;vertical-align: middle;">Product</th>
                                                            <th style="border-top: 1px solid #d5dfea;padding: 1rem;vertical-align: middle;">Quantity</th>
                                                            <th style="border-top: 1px solid #d5dfea;padding: 1rem;vertical-align: middle;" class="w-200">Price</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        ...
                                                        <tr class="cart-3">
                                                            ...
                                                            <td align="center" style="border: 1px solid #d5dfea;padding: 1rem;vertical-align: middle;">${{ $order->price }}</td>
                                                        </tr>
                                                        @endforeach
                                                        ...
                                                        <tr>
                                                            <th style="text-align: right !important;border: 1px solid #dfe3e7;padding: 1rem;vertical-align: middle;" colspan="3" class="text-right">Total</th>
                                                            <th style="border: 1px solid #dfe3e7;padding: 1rem;vertical-align: middle;">${{ $total }}</th>
                                                        </tr>
                                                        <tr>
                                                            <th style="text-align: right !important;border: 1px solid #dfe3e7;padding: 1rem;vertical-align: middle;" colspan="3" align="right">Shipping</th>
                                                            <th style="border: 1px solid #dfe3e7;padding: 1rem;vertical-align: middle;">${{ $shipping }}</th>
                                                        </tr>
                                                        <tr>
                                                            <th style="text-align: right !important;border: 1px solid #dfe3e7;padding: 1rem;vertical-align: middle;" colspan="3" align="right">Tax</th>
                                                            <th style="border: 1px solid #dfe3e7;padding: 1rem;vertical-align: middle;">${{ $tax }}
                                                            </th>
                                                        </tr>
                                                        <tr>
                                                            <th style="text-align: right !important;border: 1px solid #dfe3e7;padding: 1rem;vertical-align: middle;" colspan="3" class="text-right font-size-24 font-weight-700">Payable Amount
                                                            </th>
                                                            <th style="border: 1px solid #dfe3e7;padding: 1rem;vertical-align: middle;" class="font-size-24 font-weight-700">${{ $overallTotal }}</th>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                ...
                                <table class="es-content-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                                    ...
                                    <tr style="border-collapse:collapse">
                                        <td align="left"
                                            ...
                                            background="https://iycihw.stripocdn.email/content/guids/92d1ec79-f442-4109-8c2b-b840fc9b0eba/images/44381608293280341.gif">
                                            <div class="table-responsive" style="display: block;width: 100%;overflow-x: auto;-webkit-overflow-scrolling: touch;">
                                                <table class="table product-overview" style="width: 100%;margin-bottom: 1rem;color: #ffffff !important;border-collapse: collapse;">
                                                    <tbody>
                                                        <tr>
                                                                        ...
                                                                        <tr class="links-images-top"
                                                                            ...
                                                                            <td style="Margin:0;padding-left:5px;padding-right:5px;padding-top:35px;padding-bottom:30px;border:0"
                                                                                ...
                                                                                align="center"><a target="_blank"
                                                                                    ...
                                                                                    href=""><img
                                                                                        src="https://iycihw.stripocdn.email/content/guids/CABINET_3ef3c4a0538c293f4c84f503cd8af2cc/images/60961522067175378.png"
                                                                                        alt title height="27"
                                                                                        align="absmiddle" width="33"
                                                                            ...
                                                                            <td style="Margin:0;padding-left:5px;padding-right:5px;padding-top:35px;padding-bottom:30px;border:0"
                                                                                ...
                                                                                align="center"><a target="_blank"
                                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:20px;text-decoration:none;display:block;color:#FFFFFF"
                                                                                    href=""><img
                                                                                        src="https://iycihw.stripocdn.email/content/guids/CABINET_3ef3c4a0538c293f4c84f503cd8af2cc/images/72681522067183042.png"
                                                                                        alt title height="27"
                                                                                        align="absmiddle" width="33"
                                                                                        style="display:inline-block !important;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;padding-bottom:5px"><br></a>
                                                                            </td>
                                                                            <td style="Margin:0;padding-left:5px;padding-right:5px;padding-top:35px;padding-bottom:30px;border:0"
                                                                                ...
                                                                                align="center"><a target="_blank"
                                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:20px;text-decoration:none;display:block;color:#FFFFFF"
                                                                                    href=""><img
                                                                                        src="https://iycihw.stripocdn.email/content/guids/CABINET_3ef3c4a0538c293f4c84f503cd8af2cc/images/76121522068412489.jpg"
                                                                                        alt title height="27"
                                                                                        align="absmiddle" width="33"
                                                                                        style="display:inline-block !important;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;padding-bottom:5px"><br></a>
                                                                            </td>
                                                                            <td style="Margin:0;padding-left:5px;padding-right:5px;padding-top:35px;padding-bottom:30px;border:0"
                                                                                ...
                                                                                align="center"><a target="_blank"
                                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:20px;text-decoration:none;display:block;color:#FFFFFF"
                                                                                    href=""><img
                                                                                        src="https://iycihw.stripocdn.email/content/guids/CABINET_3ef3c4a0538c293f4c84f503cd8af2cc/images/12411522072775563.jpg"
                                                                                        alt title height="27"
                                                                                        align="absmiddle" width="50"
                                                                                        style="display:inline-block !important;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;padding-bottom:5px"><br></a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
